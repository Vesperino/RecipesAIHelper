...
/// <summary>
/// Service for scaling recipe ingredients using Google Gemini AI
/// </summary>
public class GeminiRecipeScalingService : IRecipeScalingService
{
    ...
    public GeminiRecipeScalingService(string apiKey, string modelName = "gemini-2.5-flash")
    {
        ...
        Console.WriteLine($"✅ GeminiRecipeScalingService zainicjalizowany ({modelName})");
    }
