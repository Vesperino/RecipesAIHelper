...
2. **📚 Baza przepisów**:
   - Wyszukiwanie tekstowe przepisów (nazwa, opis, typ posiłku)
   - **Zaawansowane filtrowanie**:
     - Filtrowanie po typie posiłku (śniadanie, obiad, kolacja, deser, napój)
     - Filtrowanie po wartościach odżywczych (zakresy):
       - Kalorie (0-3000 kcal)
       - Białko (0-200g)
       - Węglowodany (0-300g)
       - Tłuszcze (0-150g)
